...
import net.guerlab.smart.platform.user.server.entity.DepartmentType;
import net.guerlab.smart.platform.user.server.mapper.DepartmentTypeMapper;
import net.guerlab.smart.platform.user.server.service.DepartmentService;
import net.guerlab.smart.platform.user.server.service.DepartmentTypeService;
