...
import net.guerlab.smart.platform.user.server.entity.Permission;
...
import net.guerlab.smart.platform.user.server.mapper.PositionPermissionMapper;
import net.guerlab.smart.platform.user.server.service.PermissionService;
import net.guerlab.smart.platform.user.server.service.PositionPermissionService;
