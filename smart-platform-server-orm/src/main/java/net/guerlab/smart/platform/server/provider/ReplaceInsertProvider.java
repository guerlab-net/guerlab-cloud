 ...
 * @author guer
 */
public class ReplaceInsertProvider extends MapperTemplate {

    public ReplaceInsertProvider(Class<?> mapperClass, MapperHelper mapperHelper) {
        super(mapperClass, mapperHelper);
    }

    private static String replaceInsertIntoTable(Class<?> entityClass, String defaultTableName) {
        return "REPLACE INTO " + SqlHelper.getDynamicTableName(entityClass, defaultTableName) + " ";
    }

    public String replaceInsert(MappedStatement ms) {
        ...
        sql.append(replaceInsertIntoTable(entityClass, tableName(entityClass)));
    ...
    public String replaceInsertSelective(MappedStatement ms) {
        Class<?> entityClass = getEntityClass(ms);
        StringBuilder sql = new StringBuilder();
        //获取全部列
        Set<EntityColumn> columnList = EntityHelper.getColumns(entityClass);
